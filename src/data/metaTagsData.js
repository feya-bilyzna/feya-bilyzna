...
const mainPageKeywords = "фея, аунф, feya, atz, Купить,Купити,лифчик, ливчик,Кривой Рог, Центрацьный рынок, бюстгальтер, бюсгальтер, бюстгалтер, бюсгалтер, трусики, интернет-магазин, Lanny mode, Diorella, для годування, коригуюча білизна, спортивні та підліткові топи, плавки та боксерки, чоловіча спідня білизна, нижнее белье, стринги"
...
const contactsPageKeywords = "фея, аунф, feya, atz, магазин, кривой рог, телефон, номер, как найти, адрес, instagram, facebook,Купить,Купити,Нижнее белье,Нижня білизна,"
...
const brasKeywords = "Бюстгальтер,Лифчик,Ліфчик,Купить,Купити," + categoriesData.categories.bras.subcategories.map(subcategory => subcategory.name)
...
const knickersKeywords = "Трусы,Трусики,Труси,Купить,Купити,"+categoriesData.categories.knickers.subcategories.map(subcategory => subcategory.name)
...
const eroticKeywords = categoriesData.categories.erotic.subcategories.map(subcategory => subcategory.name) + ",сексуальное,белье,секси,"
...
const maleKeywords = "Трусы,Чоловічі,Мужские,Труси,Плавки,Боксерки,Купить,Купити,Нижнее белье,Нижня білизна,Спідня"
const teenagerDescription = "Спідня білизна для підлітків"
...
const teenagerKeywords = "Підліткове, Труси, Топіки, бюстгальтери, трусики,Купить,Купити,Нижнее белье,Нижня білизна,"
...
const weddingKeywords = "Нижня білизна, біле, свадьба, замужество, сексуальное, белье,Купить,Купити,Нижнее белье,"
...
const accessoriesKeywords = "Бретелі, подовжувачі, прозорі бретелі, удленители, прозрачное, без бретелей, без бретелек,Купить,Купити,Нижнее белье,Нижня білизна,"
...
const otherKeywords = "Бретелі, подовжувачі, прозорі бретелі, удленители, прозрачное, без бретелей, без бретелек, колготки, пояса, чулки,Купить,Купити,Нижнее белье,Нижня білизна,"
...
const saleKeywords = "Акция, скидка, распродажа, акція,Купить,Купити,Нижнее белье,Нижня білизна,"
...
const anfenKeywords = "Bretele, Maminka, Anfen, анфен, fyaty, фтаут, бренд, купити, купить,Нижнее белье,Нижня білизна,"
