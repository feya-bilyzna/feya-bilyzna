...
const brandsKeywords = categoriesData.categories.brands.subcategories.map(subcategory => subcategory.name).join()
...
const brasKeywords = categoriesData.categories.bras.subcategories.map(subcategory => subcategory.name).join()
...
const knickersKeywords = categoriesData.categories.knickers.subcategories.map(subcategory => subcategory.name).join()
...
const swimwearKeywords = categoriesData.categories.swimwear.subcategories.map(subcategory => subcategory.name).join()
